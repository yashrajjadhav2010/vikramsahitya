        ...
        <div className="max-w-4xl mx-auto px-6 md:px-12 relative z-10 text-center">
          ...
          >
            <span className="font-cinzel tracking-widest text-warm-ivory group-hover:text-antique-gold transition-colors text-sm md:text-base">
              {isOpen ? 'CLOSE CHAPTER' : 'READ CHAPTER ONE'}
            </span>
          ...
          <AnimatePresence>
            {isOpen && (
              ...
              >
                <div className="w-full aspect-[3/4] md:aspect-video rounded-2xl overflow-hidden border border-antique-gold/30 shadow-2xl relative">
                  <iframe 
